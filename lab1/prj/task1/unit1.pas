...
var
 ...
 lengh:byte;
begin
  stat:=('в хаті сонячній промінь косо на долівку ляга з вікна твої чорні шовкові коси припорошила вже сивина');
  ...
  begin
    edit1.text:=(' Введене слово наявне у вірші');
    end else
    edit1.text:=(' Введеного слова немає у вірші');
    end;
   end;
